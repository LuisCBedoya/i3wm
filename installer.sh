...
#### Xorg Packages
$i xserver-xorg-core xserver-xorg-input-evdev x11-xserver-utils x11-xkb-utils x11-utils xinit xbacklight linux-headers-amd64 build-essential pkg-config libglvnd-dev 

### intel packages
$i xserver-xorg-video-intel intel-microcode mesa-vulkan-drivers mesa-va-drivers mesa-vdpau-drivers mesa-opencl-icd mesa-utils vulkan-tools intel-media-va-driver vainfo intel-opencl-icd
# $i amd64-microcode 
#intel-gpu-tools

#### Nvidia Packages
$i nvidia-driver nvidia-settings nvidia-cuda-toolkit nvidia-opencl-dev firmware-misc-nonfree 
...
#### base packages
$i dmidecode dmraid hdparm open-iscsi mtools avahi-daemon acpi acpid sg3-utils firmware-sof-signed dosfstools dialog efitools nfs-common nilfs-tools ffmpegthumbnailer libavcodec-extra gstreamer1.0-libav gstreamer1.0-plugins-ugly gstreamer1.0-vaapi gstreamer1.0-plugins-bad xdg-utils  

### Tools
$i dunst libnotify-bin git curl wget inxi htop nvtop unrar rar tar unzip xz-utils bash-completion
...
#### User Packages
$i1 lxappearance thunar lxpolkit flameshot gpicview ripgrep
